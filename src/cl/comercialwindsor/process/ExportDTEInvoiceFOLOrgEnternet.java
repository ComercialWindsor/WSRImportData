 ...
 */
public class ExportDTEInvoiceFOLOrgEnternet extends SvrProcess
{	
	/** Properties						*/
	...
	public String CreateXMLCG(MInvoice invoice)
    {
        ...
        try
        {
          ...
          //ininoles nuevos campos de termino de pago
           ...
           // cambio para pasaporte SinnaIT
            org.w3c.dom.Text rutc;
            if(BP.get_ValueAsBoolean("pasaporte"))
            {
            	String tdoc=(String)doc.get_Value("DocumentNo");
            	if(tdoc.equals("35") ||
            	   tdoc.equals("38") ||
            	   tdoc.equals("39") ||
            	   tdoc.equals("41"))
            	{
            		  ...
            		  rutc = document.createTextNode((new StringBuilder()).append("66666666").append("-").append("6").toString());
                     
            	}
            	else
            		  rutc = document.createTextNode((new StringBuilder()).append("55555555").append("-").append("5").toString());
                
            }
            else
                rutc = document.createTextNode((new StringBuilder()).append(BP.getValue()).append("-").append(BP.get_ValueAsString("Digito")).toString());
         // org.w3c.dom.Text rutc = document.createTextNode((new StringBuilder()).append(BP.getValue()).append("-").append(BP.get_ValueAsString("Digito")).toString());
            ...
            // fin cambio para pasaporte SinnaIT
          ...
          //ininoles nueva referencia de guia de despacho
            ...
            mylog = "archivo";
	          ...
	          String ExportDirBackup = (String)company.get_Value("ExportDir2");
	          try
	          {
	          ...
	          String enternet=rut+""+typeDoc+""+invoice.getDocumentNo()+".xml";
	          ExportDir = ExportDir.replace("\\", "/");
	          ExportDirBackup = ExportDirBackup.replace("\\", "/");
	          ...
	          //javax.xml.transform.Result resultD = new StreamResult(new File(ExportDirBackup, (new StringBuilder()).append(invoice.getDocumentNo()).append("backup.xml").toString()));
    		...
    		//invoice.set_CustomColumn("DescriptionFEL","XML Enviado a Enternet. PDF Recibido");
    		//invoice.save();
    		//se guarda nuevo xml
          ...
          //  resultD = new StreamResult(new File(ExportDirBackup, (new StringBuilder()).append(invoice.getDocumentNo()).append("backupN.xml").toString()));
         ...
         // transformer.transform(source, resultD);
    		...
    		String token = "";
    		String rutEmpresa, rutUsuario, password, archivoXML, tipoDocumento, folioDocumento,archivoXML2;
    		...
    		else
    		{
        		...
        		//RutEmi891315007-Tipo41-IDF10940T41
        		
        		        		
        		invoice.set_CustomColumn("DescriptionFEL","XML Enviado a Enternet. PDF Recibido");
        		invoice.set_CustomColumn("URLXML","https://colegiopedrodevaldivia.cl/FE/all-dte/PDF/" +
    					"RutEmi"+rutEmpresa.replaceAll("-", "")+"-Tipo"+tipoDocumento+"-IDF"+folioDocumento+"T"+tipoDocumento+".pdf");
        		invoice.set_CustomColumn("URLXML2","C:\\Enternet\\EnternetAPPFull\\Agente\\ARCHIVOS\\PDF\\" +
    					"RutEmi"+rutEmpresa.replaceAll("-", "")+"-Tipo"+tipoDocumento+"-IDF"+folioDocumento+"T"+tipoDocumento+".pdf");
        ...
        return "080621 XML Generado en Repositorio Eternet. Folio: "+ invoice.getDocumentNo();
