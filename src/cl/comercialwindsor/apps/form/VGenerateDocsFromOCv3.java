 ...
 * 
 */
public class VGenerateDocsFromOCv3 extends GenerateDocsFromOCv3 implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VGenerateDocsFromOCv3.class);
	//
	...
	private CLabel     lPrintorPdf = new CLabel();
	private VComboBox  cmbPrintorPdf = new VComboBox();
	/**
	 *	Initialize Panel
	...
	void jbInit() throws Exception
	{
		...
		lDetailType.setText("Numero Copias");
		lDetailType.setLabelFor(cmbDetailType);
		lPrintorPdf.setText("Imprimir o Correo");
		lPrintorPdf.setLabelFor(cmbPrintorPdf);
    	...
    	parameterPanel.add(cmbIsTxtGen, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	parameterPanel.add(lPrintorPdf, new GridBagConstraints(4, 2, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	parameterPanel.add(cmbPrintorPdf, new GridBagConstraints(5, 2, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
	}	//	jbInit
	...
	public void dynInit() throws Exception
	{
        ...
        //DetailType
        lDetailType.setText("Numero Copias");
        cmbDetailType.addItem(new KeyNamePair(1,"1"));
        cmbDetailType.addItem(new KeyNamePair(2,"2"));
        //cmbDetailType.addItem(new KeyNamePair(3,"COMBO"));
        //PrintorPdf
        lPrintorPdf.setText("Imprimir o Correo");
        cmbPrintorPdf.addItem(new KeyNamePair(1,"Imprimir"));
        cmbPrintorPdf.addItem(new KeyNamePair(2,"Solo Correo"));
	...
	public String generate()
	{
		...
		KeyNamePair pcTypeKNPair = (KeyNamePair)cmbPrintorPdf.getSelectedItem();
		//String docActionSelected = (String)docAction.getValue();	
		return generate(panel.getStatusBar(), detTypeKNPair,pcTypeKNPair);
	}	//	generateShipments
