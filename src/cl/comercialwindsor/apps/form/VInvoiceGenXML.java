 ...
 * 
 */
public class VInvoiceGenXML extends InvoiceGenXML implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VInvoiceGenXML.class);
	//
	...
	void jbInit() throws Exception
	{
    	...
    	parameterPanel.add(dateToField, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	parameterPanel.add(selectButton, new GridBagConstraints(4, 1, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	...
    	parameterPanel.add(cmbIsTxtGen, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
    	parameterPanel.add(searchButton, new GridBagConstraints(1, 3, 3, 1, 0.0, 0.0
    			,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 5, 5), 0, 0));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (searchButton.equals(e.getSource()))
		{
		   executeQuery();
		    return;
		}
	...
	public String generate()
	{
		...
		return generate(panel.getStatusBar());
	}	//	generateShipments
