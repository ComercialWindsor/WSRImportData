...
//import org.compiere.model.X_C_EmailPos;
/**
 * Allocation Form
 *
 * @author Jorg Janke
 ...
 */
public class VGeneratePayInvoiceEmail extends CPanel implements FormPanel,
	...
	public void init(int WindowNo, FormFrame frame) {
		m_WindowNo = WindowNo;
		m_frame = frame;
		Env.setContext(Env.getCtx(), m_WindowNo, "IsSOTrx", "Y"); // defaults to
																	// no
	...
	private CTextField emailText = new CTextField();
	private JCheckBox printDocument = new JCheckBox();
	...
	private void jbInit() throws Exception {
		...
		// printDocument
		printDocument.setText("Imprimir Boleta");
		printDocument.setSelected(true);
		...
		// parameterPanel.add(organizationLabel, new GridBagConstraints(4, 0, 1,
		// 1, 0.0, 0.0
		// ,GridBagConstraints.EAST, GridBagConstraints.NONE, new
		// Insets(5,5,5,5), 0, 0));
		// parameterPanel.add(organizationPick, new GridBagConstraints(5, 0, 1,
		// 1, 0.0, 0.0
		// ,GridBagConstraints.WEST, GridBagConstraints.NONE, new
		// Insets(5,5,5,5), 0, 0));
		//
		parameterPanel.add(orderLabel, new GridBagConstraints(0, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(orderSearch, new GridBagConstraints(1, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 5, 5), 0, 0));
		parameterPanel.add(cashPay, new GridBagConstraints(2, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 0, 5, 5), 0, 0));

		parameterPanel.add(TenderLabel, new GridBagConstraints(0, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(Tendertype, new GridBagConstraints(1, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 5, 5), 0, 0));

		parameterPanel.add(AccountLabel, new GridBagConstraints(2, 1, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(BankAccount, new GridBagConstraints(3, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 5, 5), 0, 0));
		parameterPanel.add(dateLabel, new GridBagConstraints(0, 2, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(dateField, new GridBagConstraints(1, 2, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CheckNoLabel, new GridBagConstraints(2, 2, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CheckNo, new GridBagConstraints(3, 2, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CardTypeLabel, new GridBagConstraints(0, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CreditCardType, new GridBagConstraints(1, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CreditCardNumberLabel, new GridBagConstraints(2, 3,
				1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(CreditCardNumber, new GridBagConstraints(3, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));

		parameterPanel.add(A_nameLabel, new GridBagConstraints(0, 4, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(A_name, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 0, 0));
		parameterPanel.add(accountLabel, new GridBagConstraints(2, 4, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(accountNumber, new GridBagConstraints(3, 4, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));

		// email
		parameterPanel.add(EmailLabel, new GridBagConstraints(0, 5, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		parameterPanel.add(emailText, new GridBagConstraints(1, 5, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		// printDocument
		parameterPanel.add(printDocument, new GridBagConstraints(2, 5, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
	...
	private void dynInit() throws Exception {
		...
		MLookup lookupOrg = MLookupFactory.get(Env.getCtx(), m_WindowNo, 0,
				AD_Column_ID, DisplayType.TableDir);
		organizationPick = new VLookup("AD_Org_ID", true, false, true,
				lookupOrg);
		organizationPick.setValue(Env.getAD_Org_ID(Env.getCtx()));
		organizationPick.addVetoableChangeListener(this);

		m_AD_Org_ID = Env.getAD_Org_ID(Env.getCtx());
		log.info("" + m_AD_Org_ID);
		// Order
		AD_Column_ID = 4247; // C_Invoice.C_Order_ID
		MLookup lookupOrder = MLookupFactory.get(Env.getCtx(), m_WindowNo, 0,
		...
		MLookup lookupTender = MLookupFactory.get(Env.getCtx(), m_WindowNo, 0,
				AD_Column_ID, DisplayType.List);
		Tendertype = new VLookup("TenderType", true, false, true, lookupTender);
		Tendertype.addVetoableChangeListener(this);

		// Bank Account
		AD_Column_ID = 3880;
		MLookup lookupBank = MLookupFactory.get(Env.getCtx(), m_WindowNo, 0,
				AD_Column_ID, DisplayType.TableDir);
		BankAccount = new VLookup("C_BankAccount_ID", true, false, true,
				lookupBank);
		...
		AD_Column_ID = DB
				.getSQLValue(
						null,
						"select AD_Column_ID from AD_Column where AD_Table_ID=335 and upper(columnname)='BANCOS'");
		MLookup lookupBancos = MLookupFactory.get(Env.getCtx(), m_WindowNo, 0,
				AD_Column_ID, DisplayType.List);
		...
		// CreditCardType
		AD_Column_ID = 3869;
		MLookup lookupCardType = MLookupFactory.get(Env.getCtx(), m_WindowNo,
				0, AD_Column_ID, DisplayType.List);
		CreditCardType = new VLookup("CreditCardType", true, false, true,
				lookupCardType);
	...
	private void loadBPartner() {
		 ...
		 * currencyConvert(i.GrandTotal
		 * *i.MultiplierAP,i.C_Currency_ID,i.C_Currency_ID
		 ...
		 * ),i.C_Currency_ID
		 * ,i.C_Currency_ID,i.DateInvoiced,i.C_ConversionType_ID
		 * ,i.AD_Client_ID,i.AD_Org_ID)*i.MultiplierAP "Open $",
		 * invoiceDiscount(i.C_Invoice_ID,SysDate,C_InvoicePaySchedule_ID)
		 * "Discount", currencyConvert(invoiceDiscount(i.C_Invoice_ID,SysDate,
		 * C_InvoicePaySchedule_ID
		 * ),i.C_Currency_ID,i.C_Currency_ID,i.DateInvoiced
		 * ,i.C_ConversionType_ID
		 * ,i.AD_Client_ID,i.AD_Org_ID)*i.Multiplier*i.MultiplierAP
		...
		StringBuffer sql = new StringBuffer(
				"select doc.name,i.dateinvoiced,i.documentno,i.description,i.grandtotal,i.docstatus,l.name "
						+ " from c_invoice i "
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(allocateButton)) {
			...
			if (cashPay.isSelected()) {
				...
				printDocument.setVisible(false);
	...
	private void saveData() {
		...
		try {
			MOrder order = new MOrder(Env.getCtx(), m_C_Order_ID,
					trx.getTrxName());
			MInvoice invoice = null;

			int m_C_Invoice_ID = DB
					.getSQLValue(
							trx.getTrxName(),
							"select MAX(c_invoice_id) from c_invoice where docstatus IN ('DR','CO','CL') and c_order_id="
									+ m_C_Order_ID);
			...
			if (m_C_Invoice_ID <= 0)// creating invoice
			{
				// validacion antes de crear la factura
				StringBuilder sql = new StringBuilder("SELECT MAX(c.C_Cash_ID) ")
									.append(" FROM C_Cash c")
									.append(" JOIN C_CashBook cb ON c.C_CashBook_ID=cb.C_CashBook_ID")
									.append(" WHERE cb.ISDEFAULT='Y' AND cb.AD_Org_ID IN (0,").append(order.getAD_Org_ID()).append(")")
									.append(" AND cb.AD_Client_ID=").append(order.getAD_Client_ID())
									.append(" AND TRUNC(StatementDate)=?");
				int existsCash = DB.getSQLValueEx(trx.getTrxName(), sql.toString(), Env.getContextAsDate(Env.getCtx(), "#Date"));
				
				if(existsCash<=0){
					JOptionPane.showMessageDialog(this,
							"No hay una caja de efectivo disponible o no existe un libro de efectivo por defecto",
							"Error", JOptionPane.ERROR_MESSAGE);
					return;
				}

				// fin validacion
				invoice = new MInvoice(order, 0, Env.getContextAsDate(
						Env.getCtx(), "#Date"));
				...
				for (int i = 0; i < order.getLines().length; i++) {
					...
					line.saveEx(trx.getTrxName());
				}
				invoice.setDocAction(MInvoice.ACTION_Complete);
				if (invoice.processIt(MInvoice.ACTION_Complete)) {
					invoice.saveEx(trx.getTrxName());
					DB.executeUpdate("UPDATE AD_Sequence SET CurrentNext=CurrentNext+1 WHERE AD_Sequence_ID IN (" +
							" SELECT seq.AD_Sequence_ID FROM AD_Sequence seq "+
							" JOIN C_DocType dt ON dt.DOCNOSEQUENCE_ID = seq.AD_Sequence_ID" +
							" WHERE dt.C_DOCTYPE_ID = "+invoice.getC_DocTypeTarget_ID() +
							" AND seq.CurrentNext= " + invoice.getDocumentNo() +")"
							, trx.getTrxName());
				} else {
					trx.rollback();
					JOptionPane.showMessageDialog(this,
							"No se pudo completar la factura", "Error",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
			} else {
				invoice = new MInvoice(Env.getCtx(), m_C_Invoice_ID,
						trx.getTrxName());
			}

			if (m_C_Invoice_ID <= 0 && !cashPay.isSelected())// creating payment
			{
				MPayment payment = new MPayment(Env.getCtx(), 0,
						trx.getTrxName());
				// payment.setAD_Org_ID(Env.getContextAsInt(Env.getCtx(),
				// "#AD_Org_ID"));
				...
				payment.setC_BankAccount_ID(((Integer) BankAccount.getValue())
						.intValue());
				payment.setC_Currency_ID(order.getC_Currency_ID());
				payment.setIsReceipt(true);
				payment.setA_Name(A_name.getText());
				payment.saveEx(trx.getTrxName());
				...
				if (payment.processIt(MPayment.ACTION_Complete)) {
					...
					trx.rollback();
					JOptionPane.showMessageDialog(this,
							"No se pudo completar el pago", "Error",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				if (invoice != null) {
					...
					invoice.saveEx(trx.getTrxName());
					order.set_ValueOfColumn("EMail",
							(String) emailText.getValue());
					if (!printDocument.isSelected())
						order.set_ValueOfColumn("PrintDocument", "N");
					else
						order.set_ValueOfColumn("PrintDocument", "Y");
					order.saveEx(trx.getTrxName());
					String emailt = emailText.getText();
					emailt = emailt.replace(" ", "");
					if (emailt.length() > 0) {
						if (emailt.indexOf("@") > -1) {
							/*
							 * X_C_EmailPos email = new X_C_EmailPos
							 * (Env.getCtx(),0 ,trx.getTrxName());
							 * email.setEMail((String)emailText.getValue());
							 * email.set_ValueOfColumn("C_Order_ID",
							 * order.getC_Order_ID());
							 * if(!printDocument.isSelected())
							 * email.setSendEMail(true); else
							 * email.setSendEMail(false); email.saveEx();
							 */
						}
					}
				}
		...
		// Tender Type
		/*
		 * int AD_Column_ID = 5046; // C_Payment.TenderType MLookup lookupTender
		 * = MLookupFactory.get (Env.getCtx(), m_WindowNo, 0, AD_Column_ID,
		 * DisplayType.List); Tendertype = new VLookup("TenderType", true,
		 * false, true, lookupTender);
		 * Tendertype.addVetoableChangeListener(this);
		 * 
		 * //Bank Account AD_Column_ID = 3880; MLookup lookupBank =
		 * MLookupFactory.get (Env.getCtx(), m_WindowNo, 0, AD_Column_ID,
		 * DisplayType.TableDir); BankAccount = new VLookup("C_BankAccount_ID",
		 * true, false, true, lookupBank);
		 * BankAccount.addVetoableChangeListener(this);
		 * 
		 * //Bancos AD_Column_ID = DB.getSQLValue(null,
		 * "select AD_Column_ID from AD_Column where AD_Table_ID=335 and upper(columnname)='BANCOS'"
		 * ); MLookup lookupBancos = MLookupFactory.get (Env.getCtx(),
		 * m_WindowNo, 0, AD_Column_ID, DisplayType.List); Bancos = new
		 * VLookup("Bancos", true, false, true, lookupBancos);
		 * Bancos.addVetoableChangeListener(this);
		 */
		// clean
		loadBPartner();
	...
	private void generateXML(MInvoice invoice, Trx trx) {
		try {
			MXMLInvoice inv = new MXMLInvoice(invoice.getCtx(),
					invoice.getC_Invoice_ID(), trx.getTrxName());
			inv.generateXML();
		} catch (Exception e) {
			log.severe(e.toString());
			JOptionPane.showMessageDialog(this,
					"No se pudo generar el archivo xml", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public boolean validar() {
		...
		if (m_TenderType.equals("K")) {
			...
			if (CreditCardNumber.getText() == null
					|| CreditCardNumber.getText().length() == 0) {
				JOptionPane.showMessageDialog(null,
		...
		if (m_C_Order_ID == 0) {
			JOptionPane.showMessageDialog(null,
					"Debe Seleccionar una orden de venta");
			revalue = false;
		}
